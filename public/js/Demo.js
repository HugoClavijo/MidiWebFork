...
new jBox('Modal', {
  ...
  content: '<a href="https://play.google.com/store/apps/details?id=com.cuatroaventuras.seres" target="_blank">'+
	  '<img id="grafico" style="position: relative;height:auto;" src="images/game/imagen_de_ventana_emergente.jpg" alt=""></a>'+
          '<div id="ventana_body" style="line-height: 30px;">'+
		'<b>SERES</b> <br>' + 
		'El juego "Seres", explica a mediante historias, música y juegos temas de seres vivos y no vivos a niños '+
		'<br/> de 3 a 6 años de edad. Sirve como apoyo al niño, maestro y padres de familia para complementar el aprendizaje'+
		'<br/> de los niños de una forma más divertida.'+
                '<br> <br> <br> <br> '+
          '</div>'+
...
new jBox('Modal', {
  ...
  content: '<img id="grafico" style="position: relative;height:auto;" src="images/game/imagen_de_ventana2_emergente.jpg" alt="">'+
           '<div id="ventana_body" style="line-height: 30px;">'+
	   '<b>ANIMALES</b> <br>' + 
                'El juego "Animales", explica a mediante historias, música y juegos temas de animales vivos y cosas '+
                '<br/> de 3 a 6 años de edad. Sirve como apoyo al niño, maestro y padres de familia para complementar el aprendizaje'+
                '<br/> de los niños de una forma más divertida.'+
                '<br> <br> <br> <br> '+
           '</div>'+
